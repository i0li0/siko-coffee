      ...
      <div className="mx-auto max-w-2xl px-6 py-20">
        ...
        <div className="space-y-10 font-sans font-light text-sm leading-8 tracking-[0.05em]"
          ...
          <Section title="2. 取得する個人情報">
            ...
            <SubTitle className="mt-5">(4) フィードバック（ご意見・ご感想）について</SubTitle>
            <p>
              フィードバックフォーム（/feedback）からお寄せいただくご意見・ご感想は、
              匿名で取り扱います。当店は、お名前・メールアドレス・IPアドレス・端末情報など、
              送信された方を特定しうる情報を一切取得・保存しません。保存するのは、入力された内容、
              選択された種類、およびどの導線（リンク）から送信されたかの区分のみであり、
              これらの情報から個人を特定することはできません。
            </p>
          </Section>
