...
**進捗（2026-08-01 時点）: 14 / 21。** 第0群 4/4・第1群 4/4・**第2群 5/5**・**9.5 完了**。
次は **10（CloudWatch Alarms）**。⚠️ SNS トピックが0個＝通知先そのものが無いのでトピック作成から。
🔴 **10 には「CronRelay の Errors」を必ず含める**（中継 Lambda 自身の失敗は Sentry に出ない・8 の申し送り）。
