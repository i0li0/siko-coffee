...
🔴 **S-3 は 2026-08-13 に一度達成したが同日の自作自演で破れ、起算は `2026-08-13T21:24:19Z` へ**
（原因と対処は #166・教訓57）。**①〜⑤は待たずに進めてよく、待つのは⑥の手前だけ**。
...
| **14** | **soak 期間**（Vercel を生かしたまま観測） | — | 🟡 **6条件のうち5つ達成**。S-3 は `2026-08-05T19:53:07Z` → `2026-08-13T17:55:35Z` で **7日22時間・遷移0件**を一度満たした（負の対照 20件/12件つき）が、🔴 **同日 `20:31:32Z` に自作自演で破れた**（検証で打った `POST /api/checkout` の 503 が3本中1本＝33.3%）。→ アラームを率から件数へ修正（#166）。**新しい起算 `2026-08-13T21:24:19Z` ／到達 `2026-08-20T21:24Z`** |
